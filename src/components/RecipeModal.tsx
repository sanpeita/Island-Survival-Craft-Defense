  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-3xl bg-[#0c0c0c] border border-[#333] rounded-2xl shadow-[0_25px_70px_rgba(0,0,0,0.9)] overflow-hidden flex flex-col max-h-[92vh] max-h-[92dvh] text-[#e0e0e0]"
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 bg-[#121212] border-b border-[#2a2a2a] relative z-10">
          <div className="flex items-center gap-2.5 sm:gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-[9px] sm:text-[10px] uppercase tracking-widest text-amber-500 font-bold">Workshop</span>
              <h2 className="text-sm sm:text-lg font-serif italic text-[#e0e0e0]">Crafting Recipes & Codex</h2>
            </div>
          </div>
          <button
